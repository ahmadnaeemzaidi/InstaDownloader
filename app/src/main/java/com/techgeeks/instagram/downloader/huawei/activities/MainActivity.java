...
import com.techgeeks.instagram.downloader.huawei.BuildConfig;
import com.techgeeks.instagram.downloader.huawei.R;
import com.techgeeks.instagram.downloader.huawei.adapters.StoryAdapter;
import com.techgeeks.instagram.downloader.huawei.adapters.ProfileAdapter;
import com.techgeeks.instagram.downloader.huawei.api.CommonAPI;
import com.techgeeks.instagram.downloader.huawei.api.data.EdgeModel;
import com.techgeeks.instagram.downloader.huawei.api.data.EdgeSidecarModel;
import com.techgeeks.instagram.downloader.huawei.api.data.ResponseModel;
...
import com.techgeeks.instagram.downloader.huawei.dialogs.RateDialog;
import com.techgeeks.instagram.downloader.huawei.fragments.DownloadFragment;
import com.techgeeks.instagram.downloader.huawei.fragments.InstagramWebFragment;
import com.techgeeks.instagram.downloader.huawei.listener.UserListInterface;
import com.techgeeks.instagram.downloader.huawei.preference.SharePrefs;
import com.techgeeks.instagram.downloader.huawei.utils.Adclick;
import com.techgeeks.instagram.downloader.huawei.utils.Ads;
import com.techgeeks.instagram.downloader.huawei.utils.DirectoryUtils;
import com.techgeeks.instagram.downloader.huawei.utils.Utils;
...
import static com.techgeeks.instagram.downloader.huawei.utils.DirectoryUtils.createFile;


public class MainActivity extends AppCompatActivity implements UserListInterface, Adclick {
...
//                        Uri.parse("hiapplink://com.huawei.appmarket?appId=105485817")));
            }
        });
                ...
                switch (i){
                    ...
                    case 3:
                        if (methods.interstitialAd != null && methods.interstitialAd.isLoaded()) {
                            methods.showInd(MainActivity.this, MainActivity.this);
